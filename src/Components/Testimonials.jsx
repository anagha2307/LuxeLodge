...
const Testimonials = () => {
    ...
    return (
        <div className="flex flex-col items-center my-3 px-6 md:px-16 lg:px-20 bg-slate-100">
            ...
            <div className="marquee-row w-full py-4 mx-auto max-w-5xl overflow-hidden relative">
